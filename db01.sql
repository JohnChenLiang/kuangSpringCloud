...
CREATE TABLE `dept` (
  ...
  PRIMARY KEY (`deptno`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb3 COMMENT='部门表';
...
INSERT INTO `dept` VALUES (17, '\"233\"', 'db01');
INSERT INTO `dept` VALUES (18, '233', 'db01');
COMMIT;
